...
The described overheads in Sections {{handshake}} and {{record}} are independent of the underlying transport as they do not consider things like DTLS handshake message, how to compose DTLS handshake messages into records, and how the underlying layers influence the size of application plaintext sizes. An complete depends on the combination of layers as well as assumptions regarding the devices and applications and are out of scope of the document. This sections give a short overview of the overheads of UDP, TCP, and CoAP.
